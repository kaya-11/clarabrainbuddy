...
struct TodoFormView: View {
    ...
    let addTodoLabel = NSLocalizedString("edit.todo.label", comment: "Edit Todo")
    let editTodoLabel = NSLocalizedString("add.todo.label", comment: "Add New Todo")
        ...
        NavigationView {
            ...
            .toolbar {
                ToolbarItem(placement: .principal) {
                    Text(existingTodo == nil ? editTodoLabel : addTodoLabel)
                        .foregroundColor(Color.theme.primary)
                        .font(Font.app.title)
                }
            }
